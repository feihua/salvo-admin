...
pub async fn add_sys_role(req: &mut Request, res: &mut Response) {
    match req.parse_json::<AddRoleReq>().await {
        Ok(item) => {
...
pub async fn delete_sys_role(req: &mut Request, res: &mut Response) {
    match req.parse_json::<DeleteRoleReq>().await {
        Ok(item) => {
...
pub async fn update_sys_role(req: &mut Request, res: &mut Response) {
    match req.parse_json::<UpdateRoleReq>().await {
        Ok(item) => {
...
pub async fn update_sys_role_status(req: &mut Request, res: &mut Response) {
    match req.parse_json::<UpdateRoleStatusReq>().await {
        Ok(item) => {
...
pub async fn query_sys_role_detail(req: &mut Request, res: &mut Response) {
    match req.parse_json::<QueryRoleDetailReq>().await {
        Ok(item) => {
...
pub async fn query_sys_role_list(req: &mut Request, res: &mut Response) {
    match req.parse_json::<QueryRoleListReq>().await {
        Ok(item) => {
            ...
            match result {
                Ok(d) => {
                    ...
                    BaseResponse::<Vec<RoleListDataResp>>::ok_result_page(
                        res,
                        sys_role_list_data,
                        total,
                    )
...
pub async fn query_role_menu(req: &mut Request, res: &mut Response) {
    match req.parse_json::<QueryRoleMenuReq>().await {
        Ok(item) => {
...
pub async fn update_role_menu(req: &mut Request, res: &mut Response) {
    match req.parse_json::<UpdateRoleMenuReq>().await {
        Ok(item) => {
...
pub async fn query_allocated_list(req: &mut Request, res: &mut Response) {
    match req.parse_json::<AllocatedListReq>().await {
        Ok(item) => {
            ...
            match result {
                ...
                Err(err) => {
                    BaseResponse::<Vec<UserListDataResp>>::err_result_page(res, err.to_string())
                }
            }
        }
        Err(err) => {
...
pub async fn query_unallocated_list(req: &mut Request, res: &mut Response) {
    match req.parse_json::<UnallocatedListReq>().await {
        Ok(item) => {
            log::info!("update role_menu params: {:?}", &item);
...
pub async fn cancel_auth_user(req: &mut Request, res: &mut Response) {
    match req.parse_json::<CancelAuthUserReq>().await {
        Ok(item) => {
            log::info!("update role_menu params: {:?}", &item);
...
pub async fn batch_cancel_auth_user(req: &mut Request, res: &mut Response) {
    match req.parse_json::<CancelAuthUserAllReq>().await {
        Ok(item) => {
...
pub async fn batch_auth_user(req: &mut Request, res: &mut Response) {
    match req.parse_json::<SelectAuthUserAllReq>().await {
        Ok(item) => {
